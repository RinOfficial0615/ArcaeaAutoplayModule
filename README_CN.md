...
Arcaea 辅助模块，提供自动打歌、网络控制与本地自定义谱面加载。支持 6.12.11c / 6.13.2f / 6.14.0c / 6.16.2c / 6.16.8c / 7.0.0c（arm64）；自定义谱面从 6.16.2c 开始支持。
...
- 已启用 Zygisk 的设备
- Arcaea 6.12.11c、6.13.2f、6.14.0c、6.16.2c、6.16.8c 或 7.0.0c

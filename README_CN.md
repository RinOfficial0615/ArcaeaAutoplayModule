...
- 配置命名空间按功能拆分：`cfg::module`、`cfg::autoplay`、`cfg::network_block`。
...
- 若你使用其他游戏版本，需要更新 `src/config/*.h` 里的偏移与特征。
- 偏移参考文档：`docs/6.12.11c-offsets.md`。
